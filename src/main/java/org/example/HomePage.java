...
public class HomePage {
    ...
    HomePage(JFrame frame){
        ...
        label2_text1 = new JLabel("Income");
        ...
        label3_text1 = new JLabel("Savings");
        ...
        //images
        icon1 = new ImageIcon("C:\\Users\\dell\\Desktop\\java products\\Personel-Financial\\src\\assets\\images\\balance.png");
        Image scaledImage1 = icon1.getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH);
        label1.setIcon(new ImageIcon(scaledImage1));


        icon2 = new ImageIcon("C:\\Users\\dell\\Desktop\\java products\\Personel-Financial\\src\\assets\\images\\income-icon.png");
        Image scaledImage2 = icon2.getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH);
        label2.setIcon(new ImageIcon(scaledImage2));

        icon3 = new ImageIcon("C:\\Users\\dell\\Desktop\\java products\\Personel-Financial\\src\\assets\\images\\money-bag.png");
